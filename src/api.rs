use crate::models::{ApiResponse, JadwalResponse};

pub async fn get_city(city: &str) -> Result<ApiResponse, Box<dyn std::error::Error>> {
...
pub async fn get_jadwal(city_id: &str, time: &str) -> Result<JadwalResponse, Box<dyn std::error::Error>>{
